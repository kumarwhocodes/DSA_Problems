...
//        Node head_ = new Node(arr1[0]);
//        head_.next = new Node(arr1[1]);
//        head_.next.next = new Node(arr1[2]);
//        head_.next.next.next = new Node(arr1[3]);
//        head_.next.next.next.next = new Node(arr1[4]);
//        head_.next.next.next.next.next = new Node(arr1[5]);

//        Node node = deleteAllOccurencesInDLL(head,4);
//
//        P2608.printLL(node);
