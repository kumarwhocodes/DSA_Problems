...
//        P1910.Node head = new P1910.Node(1);
//        P1910.Node second = new P1910.Node(2);
//        P1910.Node third = new P1910.Node(3);
//        P1910.Node fourth = new P1910.Node(4);
//        P1910.Node fifth = new P1910.Node(5);
//
//        head.next = second;
//        second.next = third;
//        third.next = fourth;
